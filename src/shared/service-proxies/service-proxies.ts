...
export class AuthServiceProxy {
  ...
  isAuthenticated() {
    if (this.cookieService.get("Abp.AuthToken")) {
  ...
  setRoles() {
    if (this.cookieService.get("Abp.AuthToken")) {
      var decoded = this.jwtHelper.decodeToken(
        this.cookieService.get("Abp.AuthToken")
      );
      var roles = Object.keys(decoded).filter((x) => x.endsWith("/role"))[0];
      this.roles = decoded[roles];
    }
  }
  checkAdminOrManuplation() {
    if (this.roles) {
      if (this.roles.includes("Admin") || this.roles.includes("Moderator")) { 
        return true;
      } else {
        return false;
      }
   ...
   * @return Success
   */
  create(body: CreateCategoryDto | undefined): Observable<ResponseModel> {
    ...
    return this.http.post<ResponseModel>(url_, body);
  }

  get(id: number | undefined): Observable<SingleResponseModel<CategoryDto>> {
    ...
    return this.http.get<SingleResponseModel<CategoryDto>>(url_);
  }
}
...
export class ProductServiceProxy {
   ...
   * @return Success
   */
  create(body: CreateProductDto | undefined): Observable<ResponseModel> {
   ...
   * @return Success
   */
  delete(id: number | undefined): Observable<ResponseModel> {
    ...
    return this.http.delete<ResponseModel>(url_);
   ...
   * @return Success
   */
  get(id: number | undefined): Observable<SingleResponseModel<ProductDto>> {
    ...
    return this.http.get<SingleResponseModel<ProductDto>>(url_);
   ...
   * @return Success
   */
  getAll(): Observable<ListResponseModel<ProductDto>> {
    ...
    return this.http.get<ListResponseModel<ProductDto>>(url_);
    // return this.http
    //   .request("get", url_, options_)
    //   .pipe(
    //     _observableMergeMap((response_: any) => {
    ...
    //           return this.processGetAll(<any>response_);
    //         } catch (e) {
    //           return <Observable<CategoryViewDto>>(<any>_observableThrow(e));
    //         }
    //       } else
    //         return <Observable<CategoryViewDto>>(
    //           (<any>_observableThrow(response_))
    //         );
    //     })
    //   );
  ...
  getAllProductsDetail(): Observable<ListResponseModel<ProductViewDto>> {
    let url_ = this.baseUrl + "/api/services/app/Product/GetAllProductsDetail";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.get<ListResponseModel<ProductViewDto>>(url_);
    // return this.http
    //   .request("get", url_, options_)
    //   .pipe(
    //     _observableMergeMap((response_: any) => {
   ...
   * @return Success
   */
  update(body: ProductDto | undefined): Observable<ResponseModel> {
    let url_ = this.baseUrl + "/api/services/app/Product/CreateOrEdit";
    url_ = url_.replace(/[?&]$/, "");
...
export class CategoryServiceProxy {
   ...
   * @return Success
   */
  getAll(): Observable<ListResponseModel<CategoryViewDto>> {
    ...
    return this.http.get<ListResponseModel<CategoryViewDto>>(url_);
    // return this.http
    //   .request("get", url_, options_)
    //   .pipe(
    //     _observableMergeMap((response_: any) => {
  ...
  protected processGetAll(
        ...
        _observableMergeMap((_responseText) => {
          ...
          let resultData200 =
            _responseText === ""
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = CategoryViewDto.fromJS(resultData200);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
    ...
    return _observableOf<CategoryViewDto>(<any>null);
  }
   ...
   * @return Success
   */
  update(body: CategoryDto | undefined): Observable<ResponseModel> {
    let url_ = this.baseUrl + "/api/services/app/Category/CreateOrEdit";
    url_ = url_.replace(/[?&]$/, "");
...
export class CategoryViewDto implements ICategoryViewDto {
  categoryName: string | undefined;
  id: number;

  constructor(data?: ICategoryViewDto) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  static fromJS(data: any): CategoryViewDto {
    data = typeof data === "object" ? data : {};
    let result = new CategoryViewDto();
    result.init(data);
    return result;
  }
